...
{
	m_threshold = new wxSlider( this, wxID_ANY, 128, 0, 255, wxPoint(20,10), wxSize(100,50), wxSL_HORIZONTAL|wxSL_LABELS|wxEVT_SCROLL_THUMBTRACK );
	...
	m_cancelButton = new wxButton( this, wxID_CANCEL, wxT("Cancel"), wxPoint(60,100), wxDefaultSize, 0 );
}
